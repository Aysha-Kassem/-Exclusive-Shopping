...
export default function Groceries() {
    ...
    return (
        <div>
            <p className="flex justify-center items-start bg-black text-white p-5 ">Groceries Products</p>
            <div className="flex flex-wrap justify-center items-center gap-5 px-10 py-5 md:py-10 md:px-12 lg:px-20">
                {
                    products.filter(product => product.category === 'groceries').map((product, i) => (
                        <div>
