...
export default function BestSelling() {
    ...
    return (
        <div id="BestSellimg" className="space-y-5 px-10 py-5 md:py-10 md:px-12 lg:px-20">
            <div className="space-y-1">
                <div className="flex gap-3 items-center">
                    <div className="bg-red-700 w-4 h-7 rounded-sm"></div>
                    <p className="text-red-700 text-xs font-medium">This Month</p>
                </div>
                <p className="text-2xl font-medium">Best Sellimg Products</p>
            </div>
            <div className="flex gap-5 overflow-x-scroll overflow-y-hidden  h-64">
                {
                    // loop through products 
                    products.filter(product => product.rating > 4.3).map((product, i) => {
                        // console.log("y")
                        return (
                            <div >
